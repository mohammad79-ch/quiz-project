<div class="col-md-12 mb-5">
    <h3 style="font-size: 16px" class="text-success mb-4">{{$question->title}}</h3>
    ...
    @foreach($question->subQuestion as $sub)
        ...
        <a style="cursor: pointer" @if(!$checkQuestion) wire:click.prevent="checkAnswer('{{$sub->id}}')" @endif>
            <div
                class="col-md-12 justify-content-between d-flex o mt-3 alert alert-secondary  btn-outline-success">
                <div>{{$sub->title}}</div>
